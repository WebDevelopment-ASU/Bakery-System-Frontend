      ...
      <form onSubmit={handleSubmit} className={styles.profile_form}>
        ...
        <div className={styles.profile}>
          ...
          <input className={styles.input4}
            ...
            onChange={handleChange}
          />
        <button type="submit"  className={styles.Password_button}>Validate Password</button>
          </div>
        </div>
        <button type="submit"  className={styles.Edit_button}>Update Profile</button>
        <button type="submit"  className={styles.change_button}>Change Password</button>
        <button type="submit"  className={styles.delete_button}>Delete User</button>
             </form>
    </div>
    </>
  );
